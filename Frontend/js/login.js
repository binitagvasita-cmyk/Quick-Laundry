...
// ============================================
// THEME SYNCHRONIZATION FROM PARENT
// ============================================
window.addEventListener("message", function (event) {
  if (event.data.type === "THEME_CHANGED" && event.data.theme) {
    console.log("🎨 Theme change received from parent:", event.data.theme);
    htmlElement.setAttribute("data-theme", event.data.theme);
...
// ============================================
// ✅ FIXED: CHECK IF ALREADY LOGGED IN
// ============================================
function checkIfLoggedIn() {
  ...
  if (isLoggedIn && jwtToken) {
    ...
    if (isInIframe) {
      // ✅ FIX: If in iframe (modal), send notification to PARENT and close modal WITHOUT redirecting
      console.log(
      ...
      // Close modal immediately without redirecting
      setTimeout(() => {
        window.parent.postMessage(
          {
            type: "CLOSE_MODAL",
      ...
      // ✅ FIX: If standalone page, STAY on page and show info banner
      // DO NOT automatically redirect - let user choose what to do
      console.log(
        "ℹ️ Standalone login page - user already logged in but staying on page"
      );
      ...
      if (infoBanner) {
        infoBanner.innerHTML = `
          ...
          <div class="info-banner-content">
            <div class="info-banner-title">Already Logged In</div>
            <div class="info-banner-text">
              You're already logged in! <a href="home-content.html" style="color: white; text-decoration: underline;">Go to Home</a>
            </div>
          </div>
        `;
        infoBanner.style.background =
...
// ✅ Only shows notification in iframe, doesn't redirect on standalone pages
// ============================================
